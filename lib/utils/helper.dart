...
List<Video> getFakeVideos() {
  return [
    Video(
        ...
        keywords: "clay,face,janet blake,sculpture", category: '', categoryId: '', createdBy: '', cropped: '', duration: '', fileNameOriginal: '', id: '', image: '', popularity: '', videoUrl: ''),
    ...
    Video(
        ...
        keywords: "baton,dance,fire,performer,poi", category: '', categoryId: '', createdBy: '', cropped: '', duration: '', fileNameOriginal: '', id: '', image: '', popularity: '', videoUrl: ''),
    ...
    Video(
        ...
        keywords: "computer,design,graphic,tablet,youth", category: '', categoryId: '', createdBy: '', cropped: '', duration: '', fileNameOriginal: '', id: '', image: '', popularity: '', videoUrl: ''),
